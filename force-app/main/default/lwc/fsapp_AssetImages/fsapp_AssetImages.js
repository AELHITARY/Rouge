...
import {
 ...
 export default class lWCComponent extends LightningElement{
  ...
  async uploadAllPhotos() {
    console.log("uploadAllPhotos=======this.recordId======"+this.recordId);
    ...
    for (const item of allImagesCopy) {
      ...
      console.log("uploadAllPhotos=======item======"+item);
      console.log("uploadAllPhotos=======item.data======"+item.data);
      console.log("uploadAllPhotos=======fullFileName======"+fullFileName);
      console.log("uploadAllPhotos=======description======"+description);
      console.log("uploadAllPhotos=======this.recordId======"+this.recordId);      
  ...
  @api handleRowAction(event){
    console.log('handleRowAction ===1====='+JSON.stringify(event));
    console.log('handleRowAction ===2=====',JSON.stringify(event.detail));
    console.log('handleRowAction ===2=====',JSON.stringify(event.detail.row));
    console.log('handleRowAction ===3=====',JSON.stringify(event.detail.row.Id));
    console.log('handleRowAction ===4=====',JSON.stringify(event.detail.action));

     assetRecordId = event.detail.row.Id
     actionName = event.detail.action.name;
    console.log('handleRowAction ===2=====');
    console.log('recordId ===2=====',assetRecordId);
